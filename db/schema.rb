...
ActiveRecord::Schema[7.0].define(version: 2022_09_19_110656) do
  ...
  create_table "ratings", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["resource_id", "resource_type", "user_id"], name: "index_ratings_on_resource_id_and_resource_type_and_user_id", unique: true
    t.index ["resource_id", "resource_type"], name: "index_ratings_on_resource_id_and_resource_type"
  end
